...
<html lang="en">
<head>
	<title>Register NoeLelang</title>
	<!-- Meta -->
	<meta charset="utf-8">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="login-card card-block">
					<form class="md-float-material" method="post" action="<?= base_url('auth/register') ?>">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="md-input-wrapper">
									<input type="text" class="md-form-control" required="required"  placeholder="Nama" name="nama"/>
								</div>
							</div>
							<div class="col-md-12">
								<div class="md-input-wrapper">
									<input type="number" class="md-form-control" required="required" placeholder="Nomor Telepon" name="no_telp" />
								</div>
							</div>
							<div class="col-md-12">
								<div class="md-input-wrapper">
									<input type="text" class="md-form-control" required="required" placeholder="Alamat" name="alamat"/>
								</div>
							</div>
							<div class="col-md-12">
								<div class="md-input-wrapper">
